...
namespace BitcoinDataLayerAdoNet.DataSets {
    ...
    public partial class BlockDataSet : global::System.Data.DataSet {
        ...
        public partial class BlockDataTable : global::System.Data.TypedTableBase<BlockRow> {
            ...
            private global::System.Data.DataColumn columnTransactionsCount;
            
            private global::System.Data.DataColumn columnMerkleRootHash;
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public global::System.Data.DataColumn TransactionsCountColumn {
                get {
                    return this.columnTransactionsCount;
                }
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public global::System.Data.DataColumn MerkleRootHashColumn {
                get {
                    return this.columnMerkleRootHash;
                }
            }
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public BlockRow AddBlockRow(long BlockId, int BlockchainFileId, int BlockVersion, byte[] BlockHash, byte[] PreviousBlockHash, int TransactionsCount, byte[] MerkleRootHash, System.DateTime BlockTimestamp) {
            ...
            internal void InitVars() {
                ...
                this.columnTransactionsCount = base.Columns["TransactionsCount"];
                this.columnMerkleRootHash = base.Columns["MerkleRootHash"];
            ...
            private void InitClass() {
                ...
                this.columnTransactionsCount = new global::System.Data.DataColumn("TransactionsCount", typeof(int), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnTransactionsCount);
                this.columnMerkleRootHash = new global::System.Data.DataColumn("MerkleRootHash", typeof(byte[]), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnMerkleRootHash);
                ...
                this.columnTransactionsCount.AllowDBNull = false;
                this.columnMerkleRootHash.AllowDBNull = false;
        ...
        public partial class BlockRow : global::System.Data.DataRow {
            ...
            public int TransactionsCount {
                get {
                    return ((int)(this[this.tableBlock.TransactionsCountColumn]));
                }
                set {
                    this[this.tableBlock.TransactionsCountColumn] = value;
                }
            }
            ...
            public byte[] MerkleRootHash {
                get {
                    return ((byte[])(this[this.tableBlock.MerkleRootHashColumn]));
                }
                set {
                    this[this.tableBlock.MerkleRootHashColumn] = value;
                }
            }
...
namespace BitcoinDataLayerAdoNet.DataSets.BlockDataSetTableAdapters {
    ...
    public partial class BlockTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("TransactionsCount", "TransactionsCount");
            tableMapping.ColumnMappings.Add("MerkleRootHash", "MerkleRootHash");
            tableMapping.ColumnMappings.Add("BlockTimestamp", "BlockTimestamp");
            this._adapter.TableMappings.Add(tableMapping);
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Block] WHERE (([BlockId] = @Original_BlockId) AND ([BlockchainFileId] = @Original_BlockchainFileId) AND ([BlockVersion] = @Original_BlockVersion) AND ([BlockHash] = @Original_BlockHash) AND ([PreviousBlockHash] = @Original_PreviousBlockHash) AND ([TransactionsCount] = @Original_TransactionsCount) AND ([MerkleRootHash] = @Original_MerkleRootHash) AND ([BlockTimestamp] = @Original_BlockTimestamp))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_TransactionsCount", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "TransactionsCount", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_MerkleRootHash", global::System.Data.SqlDbType.VarBinary, 0, global::System.Data.ParameterDirection.Input, 0, 0, "MerkleRootHash", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Block] ([BlockId], [BlockchainFileId], [BlockVersion], [BlockHash], [PreviousBlockHash], [TransactionsCount], [MerkleRootHash], [BlockTimestamp]) VALUES (@BlockId, @BlockchainFileId, @BlockVersion, @BlockHash, @PreviousBlockHash, @TransactionsCount, @MerkleRootHash, @BlockTimestamp);
SELECT BlockId, BlockchainFileId, BlockVersion, BlockHash, PreviousBlockHash, TransactionsCount, MerkleRootHash, BlockTimestamp FROM Block WHERE (BlockId = @BlockId)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@TransactionsCount", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "TransactionsCount", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@MerkleRootHash", global::System.Data.SqlDbType.VarBinary, 0, global::System.Data.ParameterDirection.Input, 0, 0, "MerkleRootHash", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Block] SET [BlockId] = @BlockId, [BlockchainFileId] = @BlockchainFileId, [BlockVersion] = @BlockVersion, [BlockHash] = @BlockHash, [PreviousBlockHash] = @PreviousBlockHash, [TransactionsCount] = @TransactionsCount, [MerkleRootHash] = @MerkleRootHash, [BlockTimestamp] = @BlockTimestamp WHERE (([BlockId] = @Original_BlockId) AND ([BlockchainFileId] = @Original_BlockchainFileId) AND ([BlockVersion] = @Original_BlockVersion) AND ([BlockHash] = @Original_BlockHash) AND ([PreviousBlockHash] = @Original_PreviousBlockHash) AND ([TransactionsCount] = @Original_TransactionsCount) AND ([MerkleRootHash] = @Original_MerkleRootHash) AND ([BlockTimestamp] = @Original_BlockTimestamp));
SELECT BlockId, BlockchainFileId, BlockVersion, BlockHash, PreviousBlockHash, TransactionsCount, MerkleRootHash, BlockTimestamp FROM Block WHERE (BlockId = @BlockId)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@TransactionsCount", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "TransactionsCount", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@MerkleRootHash", global::System.Data.SqlDbType.VarBinary, 0, global::System.Data.ParameterDirection.Input, 0, 0, "MerkleRootHash", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_TransactionsCount", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "TransactionsCount", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_MerkleRootHash", global::System.Data.SqlDbType.VarBinary, 0, global::System.Data.ParameterDirection.Input, 0, 0, "MerkleRootHash", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT   BlockId, BlockchainFileId, BlockVersion, BlockHash, PreviousBlockHash, T" +
                "ransactionsCount, MerkleRootHash, \r\n                BlockTimestamp\r\nFROM      Bl" +
                "ock";
        ...
        public virtual int Delete(long Original_BlockId, int Original_BlockchainFileId, int Original_BlockVersion, byte[] Original_BlockHash, byte[] Original_PreviousBlockHash, int Original_TransactionsCount, byte[] Original_MerkleRootHash, System.DateTime Original_BlockTimestamp) {
            ...
            this.Adapter.DeleteCommand.Parameters[5].Value = ((int)(Original_TransactionsCount));
            if ((Original_MerkleRootHash == null)) {
                throw new global::System.ArgumentNullException("Original_MerkleRootHash");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[6].Value = ((byte[])(Original_MerkleRootHash));
            }
            this.Adapter.DeleteCommand.Parameters[7].Value = ((System.DateTime)(Original_BlockTimestamp));
        ...
        public virtual int Insert(long BlockId, int BlockchainFileId, int BlockVersion, byte[] BlockHash, byte[] PreviousBlockHash, int TransactionsCount, byte[] MerkleRootHash, System.DateTime BlockTimestamp) {
            ...
            this.Adapter.InsertCommand.Parameters[5].Value = ((int)(TransactionsCount));
            if ((MerkleRootHash == null)) {
                throw new global::System.ArgumentNullException("MerkleRootHash");
            }
            else {
                this.Adapter.InsertCommand.Parameters[6].Value = ((byte[])(MerkleRootHash));
            }
            this.Adapter.InsertCommand.Parameters[7].Value = ((System.DateTime)(BlockTimestamp));
        ...
        public virtual int Update(
                    ...
                    int Original_TransactionsCount, 
                    byte[] Original_MerkleRootHash, 
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(TransactionsCount));
            if ((MerkleRootHash == null)) {
                throw new global::System.ArgumentNullException("MerkleRootHash");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[6].Value = ((byte[])(MerkleRootHash));
            }
            this.Adapter.UpdateCommand.Parameters[7].Value = ((System.DateTime)(BlockTimestamp));
            this.Adapter.UpdateCommand.Parameters[8].Value = ((long)(Original_BlockId));
            this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(Original_BlockchainFileId));
            this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(Original_BlockVersion));
            if ((Original_BlockHash == null)) {
                throw new global::System.ArgumentNullException("Original_BlockHash");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[11].Value = ((byte[])(Original_BlockHash));
            }
            if ((Original_PreviousBlockHash == null)) {
                throw new global::System.ArgumentNullException("Original_PreviousBlockHash");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[12].Value = ((byte[])(Original_PreviousBlockHash));
            }
            this.Adapter.UpdateCommand.Parameters[13].Value = ((int)(Original_TransactionsCount));
            if ((Original_MerkleRootHash == null)) {
                throw new global::System.ArgumentNullException("Original_MerkleRootHash");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[14].Value = ((byte[])(Original_MerkleRootHash));
            }
            this.Adapter.UpdateCommand.Parameters[15].Value = ((System.DateTime)(Original_BlockTimestamp));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int BlockchainFileId, int BlockVersion, byte[] BlockHash, byte[] PreviousBlockHash, int TransactionsCount, byte[] MerkleRootHash, System.DateTime BlockTimestamp, long Original_BlockId, int Original_BlockchainFileId, int Original_BlockVersion, byte[] Original_BlockHash, byte[] Original_PreviousBlockHash, int Original_TransactionsCount, byte[] Original_MerkleRootHash, System.DateTime Original_BlockTimestamp) {
            return this.Update(Original_BlockId, BlockchainFileId, BlockVersion, BlockHash, PreviousBlockHash, TransactionsCount, MerkleRootHash, BlockTimestamp, Original_BlockId, Original_BlockchainFileId, Original_BlockVersion, Original_BlockHash, Original_PreviousBlockHash, Original_TransactionsCount, Original_MerkleRootHash, Original_BlockTimestamp);
        }
    }
