...
namespace BitcoinBlockchain.Data
{
    ...
    public class Transaction
    {
        ...
        public Transaction()
        {
            ...
            this.TransactionInputsCount = 0;
            this.TransactionOutputsCount = 0;
            this.IsSegWit = false;
        ...
        ///<summary>
        ///Gets or Sets the TXInCount
        /// </summary>
        public int TransactionInputsCount { get; set; }

        ///<summary>
        ///Gets or Sets the TXOutCount;
        /// </summary>
        public int TransactionOutputsCount { get; set; }
